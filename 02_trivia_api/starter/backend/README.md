...
- General: There are three main endpoints mainly- /,/add,/play
    - On the main page list of categories and questions are returned.
    - On /add page you add a question in the database.
    - On /play, you can play quiz according to categories.
    - These three pages internally has different endpoints like /questions,/categories etc. Explained some as follows-
